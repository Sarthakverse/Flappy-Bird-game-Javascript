//sound
let gameBackgroundSound = document.getElementById("game-background-sound");
...
window.onload = function() {
    ...
    gameBackgroundSound.addEventListener("canplaythrough", function() {
        gameBackgroundSound.play();
        gameFeatherSound.play();
